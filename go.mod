...
require (
	cloudeng.io/aws v0.0.0-20260817221234-f34e7b6f24cd
	...
	cloudeng.io/security v0.0.0-20260817221234-f34e7b6f24cd
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/sesv2 v1.66.6 // indirect
